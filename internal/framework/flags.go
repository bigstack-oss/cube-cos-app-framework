...
func ParseFlags(cmd *cobra.Command, spec *configs.Spec) {
	...
	cmd.Flags().StringVarP(&spec.Framework.Networks.LoadBalancer.Image, "net.loadbalancer.image", "", spec.Framework.Networks.LoadBalancer.Image, "Load balancer image for the framework")
